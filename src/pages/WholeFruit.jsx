    ...
    <main className="bg-[#faf9f5] text-zinc-900 selection:bg-[#9ef295] selection:text-black">
        ...
        <div className="w-full md:w-[45%] bg-gradient-to-br from-[#7e1a12] to-black flex flex-col justify-center px-8 md:px-16 py-12 md:pt-32 md:pb-16 relative z-10">
          <div className="max-w-md animate-in">
            ...
            <h1 className="text-4xl md:text-7xl font-serif font-bold text-white leading-[0.9] mb-6 md:mb-8 uppercase tracking-tighter">
              Whole <br/><span className="text-[#9ef295]">Fruit</span>
            </h1>
            <p className="text-white/70 text-sm md:text-base leading-relaxed font-sans mb-8 md:mb-10">
              Sourced exclusively from captive and contract-managed farms, our Bhagwa whole pomegranates are cultivated under strict protocols.
            </p>
            
            {/* Product Attributes Tags */}
            <div className="flex flex-wrap gap-2 mb-8 md:mb-10">
              <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-[9px] text-white/60 uppercase tracking-widest font-bold">Global MRL Compliant</span>
              <span className="px-3 py-1 bg-[#9ef295]/20 border border-[#9ef295]/30 rounded-full text-[9px] text-[#9ef295] uppercase tracking-widest font-bold">Export Ready</span>
            </div>

            <div className="flex gap-4">
              <a href="#spec" className="w-full md:w-auto text-center bg-[#0d631b] text-white px-8 md:px-10 py-4 md:py-5 rounded-full font-display font-bold tracking-widest uppercase hover:bg-white hover:text-[#0d631b] transition-all shadow-xl">Get Full Spec</a>
            </div>
          </div>
        </div>
        <div className="w-full md:w-[55%] relative h-[400px] md:h-auto">
          <img alt="Whole Pomegranate Fruit" className="absolute inset-0 w-full h-full object-cover" src="/pomegranate_3d.png"/>
      ...
      <section id="spec" className="bg-zinc-950 py-12 md:py-24 px-6 md:px-12 relative overflow-hidden">
        <div className="max-w-screen-2xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 md:mb-16 gap-6 md:gap-8">
            ...
            <p className="text-white/40 font-display font-bold uppercase tracking-widest text-[10px]">Global Standards Compliant</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            <div className="bg-white/5 p-8 md:p-10 rounded-[1.5rem] md:rounded-[2rem] border-l-4 border-[#9ef295]">
              ...
              <p className="text-lg md:text-xl font-serif font-bold text-white mb-2">60-90 Days</p>
              <p className="text-[10px] text-white/40 font-sans">Packaging Dependent</p>
            </div>
            <div className="bg-white/5 p-8 md:p-10 rounded-[1.5rem] md:rounded-[2rem] border-l-4 border-[#0d631b]">
              <h4 className="font-display font-bold text-white/30 uppercase text-[9px] tracking-widest mb-4">Variety</h4>
              <p className="text-lg md:text-xl font-serif font-bold text-white mb-2">Bhagwa</p>
              <p className="text-[10px] text-white/40 font-sans">Single Variety</p>
            </div>
            <div className="bg-white/5 p-8 md:p-10 rounded-[1.5rem] md:rounded-[2rem] border-l-4 border-[#7e1a12]">
              ...
              <p className="text-lg md:text-xl font-serif font-bold text-white mb-2">Captive & Contract</p>
              <p className="text-[10px] text-white/40 font-sans">Full Traceability</p>
            </div>
            <div className="bg-white/5 p-8 md:p-10 rounded-[1.5rem] md:rounded-[2rem] border-l-4 border-white/20">
              <h4 className="font-display font-bold text-white/30 uppercase text-[9px] tracking-widest mb-4">Supply</h4>
              <p className="text-lg md:text-xl font-serif font-bold text-white mb-2">365-Day</p>
              <p className="text-[10px] text-white/40 font-sans">Year-Round Capability</p>
            </div>
          </div>

          {/* Dispatch Windows */}
          <div className="mt-12 md:mt-16">
            <h4 className="font-display font-bold text-white/30 uppercase text-[10px] tracking-widest mb-6 md:mb-8 text-center md:text-left">Dispatch Windows</h4>
            <div className="flex flex-wrap justify-center md:justify-start gap-4 md:gap-6">
              {['Jan', 'Feb', 'Mar', 'Jul', 'Aug', 'Sep', 'Dec'].map((month) => (
      ...
      <section className="py-12 md:py-20 px-6 md:px-12 text-center bg-white">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-4xl font-serif font-bold text-zinc-900 mb-8">Reliable, scalable SKU for high-volume trade buyers.</h2>
          <button className="w-full sm:w-auto bg-[#0d631b] text-white px-10 py-4 rounded-md font-bold tracking-widest uppercase hover:opacity-90 transition-all">Request Quote</button>
        </div>
      </section>
    </main>
  )
